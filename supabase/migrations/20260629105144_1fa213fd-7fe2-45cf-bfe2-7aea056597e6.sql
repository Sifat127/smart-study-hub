...
DECLARE
  ...
  own_select_rows int;
  own_select_with_uid_predicate int;
...
BEGIN
  ...
  -- Diagnostic: can Alice SELECT her own row via RLS?
  SELECT count(*) INTO own_select_rows
  FROM public.profiles WHERE user_id = alice_id;

  SELECT count(*) INTO own_select_with_uid_predicate
  ...
  RETURN jsonb_build_object(
    ...
    'own_select_rows', own_select_rows,
    'own_select_with_uid_predicate', own_select_with_uid_predicate,
