...
export const departments: Department[] = [
  { id: "cse", name: "CSE", fullName: "Computer Science & Engineering", description: "Programming, algorithms, data structures, AI, networking and more.", icon: "Monitor", totalCourses: 58 },
  { id: "eee", name: "EEE", fullName: "Electrical & Electronic Engineering", description: "Circuits, power systems, electronics, signal processing and control systems.", icon: "Zap", totalCourses: 43 },
  { id: "bba", name: "BBA", fullName: "Bachelor of Business Administration", description: "Management, marketing, finance, accounting and business strategy.", icon: "Briefcase", totalCourses: 39 },
  { id: "swe", name: "SWE", fullName: "Software Engineering", description: "Software development, testing, project management and system design.", icon: "Code", totalCourses: 38 },
  { id: "cis", name: "CIS", fullName: "Computing & Information System", description: "Information systems, database management and enterprise solutions.", icon: "Database", totalCourses: 20 },
  { id: "pharmacy", name: "PHARMACY", fullName: "Department of Pharmacy", description: "Pharmaceutical sciences, drug design, pharmacology and clinical practice.", icon: "Pill", totalCourses: 21 },
  { id: "english", name: "ENGLISH", fullName: "Department of English", description: "English language, literature, linguistics and communication studies.", icon: "BookText", totalCourses: 15 },
  { id: "law", name: "LAW", fullName: "Department of Law", description: "Legal studies, constitutional law, criminal law and corporate law.", icon: "Scale", totalCourses: 16 },
  { id: "textile", name: "TEXTILE", fullName: "Textile Engineering", description: "Textile manufacturing, fiber science, fabric design and apparel technology.", icon: "Shirt", totalCourses: 16 },
  { id: "arch", name: "ARCH", fullName: "Department of Architecture", description: "Architectural design, urban planning, construction and environmental design.", icon: "Building2", totalCourses: 14 },
  { id: "jmc", name: "JMC", fullName: "Journalism, Media & Communication", description: "Mass communication, digital media, journalism and public relations.", icon: "Radio", totalCourses: 13 },
  { id: "thm", name: "THM", fullName: "Tourism & Hospitality Management", description: "Tourism planning, hotel management, event management and hospitality.", icon: "Plane", totalCourses: 11 },
